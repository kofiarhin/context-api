...
module.exports = [
  {
    ...
    evidence: [
      {
        type: 'repository',
        reference: 'kofiarhin/context-api/docs/SPEC.md#7-shared-data-rules',
        note: 'Shared data rules.',
      },
      {
        type: 'repository',
        reference: 'kofiarhin/context-api/docs/SPEC.md#10-validation',
        note: 'Object IDs accepted only where explicit.',
      },
    ],
  ...
  },
  {
    ...
    evidence: [
      {
        type: 'repository',
        reference: 'kofiarhin/context-api/docs/SPEC.md#64-query-behavior',
        note: null,
      },
    ],
    reviewStatus: 'reviewed',
  ...
  },
  {
    ...
    evidence: [
      {
        type: 'repository',
        reference: 'kofiarhin/context-api/docs/SPEC.md#82-coding-convention',
  ...
  },
  {
    ...
    evidence: [
      {
        type: 'repository',
        reference: 'kofiarhin/context-api/docs/PRD.md#13-security-position-for-mvp',
        note: null,
      },
    ],
    reviewStatus: 'reviewed',
  ...
  },
  {
    ...
    evidence: [
      {
        type: 'repository',
        reference: 'kofiarhin/context-api/docs/SPEC.md#17-performance-boundaries',
        note: 'No endpoint returns all domains.',
      },
    ],
    reviewStatus: 'reviewed',
    supersedes: null,
  ...
  },
  {
    ...
    evidence: [
      {
        type: 'repository',
        reference: 'kofiarhin/context-api/docs/SPEC.md#12-seed-data',
        note: null,
      },
    ],
    reviewStatus: 'reviewed',
