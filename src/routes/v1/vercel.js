...
router.post(
  '/projects/:project/pause',
  validateVercelParams,
  validateVercelBody,
  controller.pauseProject
);
router.post(
  '/projects/:project/unpause',
  validateVercelParams,
  validateVercelBody,
  controller.unpauseProject
);
router.post(
  '/projects/:project/rollback',
  validateVercelParams,
  validateVercelBody,
  controller.rollbackProject
);
...
router.get(
  ...
  validateVercelParams,
  validateVercelQuery,
  controller.getDeploymentEvents
);
router.get(
...
router.post(
  '/deployments/:deployment/promote',
  validateVercelParams,
  validateVercelBody,
  controller.promoteDeployment
);
...
router.get(
  ...
  validateVercelParams,
  validateVercelQuery,
  controller.listEnvironmentVariables
);
router.post(
  '/projects/:project/environment-variables',
  validateVercelParams,
  validateVercelBody,
  controller.createEnvironmentVariable
);
router.patch(
  '/projects/:project/environment-variables/:variable',
  validateVercelParams,
  validateVercelBody,
...
router.delete(
  ...
  validateVercelParams,
  validateVercelBody,
  controller.deleteEnvironmentVariable
);
...
router.get(
  ...
  validateVercelParams,
  validateVercelQuery,
  controller.listDnsRecords
);
router.post(
  '/domains/:domain/dns',
  validateVercelParams,
  validateVercelBody,
  controller.createDnsRecord
);
router.patch(
  '/domains/:domain/dns/:record',
  validateVercelParams,
  validateVercelBody,
  controller.updateDnsRecord
);
router.delete(
  '/domains/:domain/dns/:record',
  validateVercelParams,
